...
vignette: >
  %\VignetteIndexEntry{cv_multiple_alg}
...
We can extract estimates from the `est_cv` object and plot the population average prescriptive effect difference by comparing different ML algorithms.


```{r multiple_papdp, warning = FALSE, message = FALSE, fig.width = 6, fig.height = 4}
# plot GATE estimates
library(ggplot2)
summary(user_itr)$PAPDp %>%
