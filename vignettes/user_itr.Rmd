...
We can extract estimates from the `user_itr` object and visualize them. The following code shows how to extract the GATE estimates for the writing score with the causal forest algorithm. 
